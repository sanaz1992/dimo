...
use Modules\UI\Http\Livewire\SortSelect;
use Modules\UI\Http\Livewire\Tabs;
...
class UIServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->publishes([
            __DIR__.'/../Resources/assets' => public_path('ui'),
        ], ['public', 'laravel-assets']);

        Livewire::component('UI::tabs', Tabs::class);
        Livewire::component('UI::sort-select', SortSelect::class);
    }
