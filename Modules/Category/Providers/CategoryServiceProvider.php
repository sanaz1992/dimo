...
class CategoryServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Livewire::component('category::create', CategoryCreate::class);
        Livewire::component('category::edit', CategoryEdit::class);
    }
    ...
    {
        $categoryLangPath = module_path($this->name, 'resources/lang');

        if (is_dir($categoryLangPath)) {
            $this->loadTranslationsFrom($categoryLangPath, $this->nameLower);
            $this->loadJsonTranslationsFrom($categoryLangPath);
        }
    }
