...
use Modules\Media\External\MediaRepository;
use Modules\Media\Http\Livewire\ImageUploadInput;
use Modules\Media\Services\UploadStrategies\LiaraUploadStrategy;
...
class MediaServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Livewire::component('media.image-upload-input', ImageUploadInput::class);
    }
    ...
    public function register(): void
    {
        ...
        $this->app->bind(FileUploadStrategyInterface::class, LiaraUploadStrategy::class);
