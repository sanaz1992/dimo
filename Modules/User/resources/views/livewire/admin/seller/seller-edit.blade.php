<div class="container mx-auto px-4 rtl">
    <section class="rounded-xl border border-gray-200 bg-white p-4 sm:p-6 shadow-sm">
        ...
        <h2 class="text-2xl font-bold mb-4">{{ __('user::attributes.sellers_edit') }} {{$user->name}}</h2>
                ...
                <div class="grid gap-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" wire:model="form.name" class="w-full rounded-lg border-gray-300"
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="form.mobile" class="w-full rounded-lg border-gray-300"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="mb-2 block text-sm font-medium">{{__('user::attributes.province')}}</label>
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium">{{__('user::attributes.city')}}</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                        <div>
                            <label class="mb-2 block text-sm font-medium">{{ __('user::attributes.address') }}</label>
                            <input type="text" wire:model="form.address" class="w-full rounded-lg border-gray-300"
                                placeholder="{{__('user::messages.enter_address')}}" />
                            @error('form.address')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label
                                class="mb-2 block text-sm font-medium">{{ __('user::attributes.postal_code') }}</label>
                            <input type="text" wire:model="form.postal_code" class="w-full rounded-lg border-gray-300"
                                placeholder="{{__('user::messages.enter_postal_code')}}" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="mb-2 block text-sm font-medium">{{ __('user::attributes.password') }}</label>
                            <input type="password" wire:model="form.password" class="w-full rounded-lg border-gray-300"
                        ...
                        <div>
                            <label
                                class="mb-2 block text-sm font-medium">{{ __('user::attributes.password_confirmation') }}</label>
