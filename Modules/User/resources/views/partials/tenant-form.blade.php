<section class="panel p-5 anim-fade-up">
    ...
    <form wire:submit.prevent="store">
        <div class="relative z-[1] space-y-3">
            ...
            <x-dashboard::forms.select label="user::attributes.timezone" name="form.timezone" wire:model.defer="form.timezone"
                :options="$timezones" placeholder="user::messages.select_timezone" />

            <x-dashboard::forms.select label="user::attributes.local" name="form.local" wire:model.defer="form.local"
                :options="$locals" placeholder="user::messages.select_local" />
